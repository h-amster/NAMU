...
var trigger1 = document.querySelector('.dropdown__trigger');
var dropdown2 = document.querySelectorAll('.dropdown')[1];
var trigger2 = document.querySelectorAll('.dropdown__trigger')[1];
...
var visitSection = document.querySelector('.visit');

function checkScroll() {
  var windowHeight = window.innerHeight;
  var visitPosition = visitSection.getBoundingClientRect().top;
